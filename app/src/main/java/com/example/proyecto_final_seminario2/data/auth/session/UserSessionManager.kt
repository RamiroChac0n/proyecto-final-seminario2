...
/**
 * Maneja la sesion del usuario autenticado en almacenamiento local simple.
 *
 * Solo persiste datos no sensibles de sesion; la contraseña nunca se guarda
 * aqui, porque vive como hash en Room.
 */
class UserSessionManager(context: Context) {
    ...
    fun getCurrentUser(): AuthUser? {
        ...
        // NO_USER_ID representa la ausencia de una sesion valida.
        if (id == NO_USER_ID) {
            return null
        }
