...
/**
 * Fuente remota para Google Places SDK.
 *
 * Expone operaciones suspendidas para que el resto de la app trabaje con
 * coroutines en lugar de callbacks de Task.
 */
class GooglePlacesDataSource(
    private val placesClient: PlacesClient?
) {
    // Campos minimos para pintar tarjetas de busqueda y reducir costo/carga de red.
    ...
    // Campos ampliados usados por la pantalla de detalle del negocio.
    ...
    suspend fun searchNearby(
        ...
        return try {
            ...
            // SearchNearby requiere un radio geografico; la categoria limita tipos cuando aplica.
    ...
    suspend fun searchByText(
        ...
        return try {
            // La categoria se agrega al texto para mejorar relevancia cuando el usuario filtra.
            ...
            if (latitude != null && longitude != null) {
                ...
                // LocationBias prioriza resultados cercanos sin excluir coincidencias utiles.
    ...
    private fun Place.resolveCategory(
        ...
        // Si el usuario filtro por categoria, se conserva esa intencion en el resultado.
    ...
    private suspend fun Place.resolvePhotoUri(
        ...
        // La URI resuelta permite mostrar imagenes sin manejar manualmente bytes de fotos.
    ...
    private suspend fun <T> Task<T>.awaitTask(): T {
        // Adaptador pequeno entre Task de Google Play Services y coroutines de Kotlin.
