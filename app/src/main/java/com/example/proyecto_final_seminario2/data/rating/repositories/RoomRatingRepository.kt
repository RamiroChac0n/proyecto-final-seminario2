...
/**
 * Persistencia y calculo de valoraciones locales.
 *
 * Cada valoracion queda asociada al usuario en sesion y al negocio evaluado.
 */
class RoomRatingRepository(
    ...
    override suspend fun saveRating(
        ...
        return try {
            ...
            // Se guarda una copia de datos basicos del lugar para mostrar historial en perfil.
    ...
    override suspend fun getLocalRatingSummary(
        ...
        return try {
            ...
            // Porcentaje simple de usuarios que recomendarian el lugar.
            val recommendationPercent = (
                    ratings.count { it.recommends }.toFloat() / total.toFloat() * 100
                    ).toInt()

            // Se toma la opcion modal para resumir el tiempo de espera mas habitual.
            ...
            // Se agrupan cualidades guardadas como enum names y se devuelven etiquetas legibles.
